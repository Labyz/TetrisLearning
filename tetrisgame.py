    ...
    def run(self):
        ...
        while not self.perdu:
            ...
            for y, row in enumerate(self.board):
                pygame.draw.line(self.screen, (255, 255, 255), (0,y * 20),(10 * 20,y * 20))
                for x, val in enumerate(row):
                    if y == 0:
                        pygame.draw.line(self.screen, (255, 255, 255), (x * 20,0), (x * 20, 24 * 20))
                    if val:
                        pygame.draw.rect(
                            self.screen,
                            colors[val],
                            pygame.Rect(x * 20, y * 20, 20, 20), 0)
            pygame.draw.line(self.screen, (255, 255, 255), (0, 24 * 20 -1), (10 * 20, 24 * 20 -1))
            pygame.draw.line(self.screen, (255, 255, 255), (10 * 20, 0), (10 * 20, 24 * 20))
            for y, row in enumerate(self.tetromino):
                for x, val in enumerate(row):
                    if val:
                        pygame.draw.rect(
